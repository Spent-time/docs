...
var config = {
  ...
  site_title: 'Spent time Docs',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '/docs',

  // Used for the "Get in touch" page footer link
  support_email: 'support@spent-time.com',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; '+ new Date().getFullYear() +' - <a href="https://spent-time.com">Spent time</a>',
