  ...
  $(document).ready(function () {
    ...
    $("#add-page-confirm").click(function () {
      ...
      $.post("/docs/rn-add-page", {
        ...
        if (data.status === 403) { window.location = "/docs/login"; }
      });
    });
    ...
    $.getJSON("/docs/translations/" + $("html").prop("lang") + ".json", null, function (lang) {
      ...
      $(".save-page").click(function () {
        ...
        $.post("/docs/rn-edit", {
          file    : decodeURI(file_arr.join("/").replace('/docs','')),
